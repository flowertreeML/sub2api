...
var (
	...
	AccountsColumns = []*schema.Column{
		...
		{Name: "cost_per_million_input", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "cost_per_million_output", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "status", Type: field.TypeString, Size: 20, Default: "active"},
	...
	AccountsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{AccountsColumns[12], AccountsColumns[16]},
			},
			{
